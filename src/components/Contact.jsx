  ...
  const socialLinks = [
    ...
    },
    {
      ...
      icon: (
        ...
        >
          <path
            d="M22.675 0H1.325C.595 0 0 .595 0 1.326v21.348C0 23.405.595 24 1.325 24H12.82V14.745H9.692v-3.622h3.128V8.413c0-3.1 1.894-4.788 4.658-4.788 1.325 0 2.462.099 2.794.143v3.24h-1.918c-1.504 0-1.796.715-1.796 1.764v2.31h3.587l-.467 3.622h-3.12V24h6.116c.73 0 1.325-.595 1.325-1.326V1.326C24 .595 23.405 0 22.675 0z"
            fill="currentColor"
          />
        </svg>
      ),
